...
with CategoriesViewModelInputs , CategoriesViewModelOutputs {
  ...
  Stream<List<CategoriesObject>> get outputCategoriesObject =>
      _categoryObjectStreamController.stream
          .map((categoryObject) => categoryObject);

  void _postDataToView() {
    inputCategoriesObject.add(_list);
  }

  List<CategoriesObject> _getCategoriesObject() => [
        CategoriesObject(
            true, ImageAssets.decoration, AppStrings.decoration, '827 items'),
        CategoriesObject(
            true, ImageAssets.ceiling, AppStrings.ceiling, '827 items'),
        CategoriesObject(
            true, ImageAssets.floor, AppStrings.floor, '827 items'),
        CategoriesObject(
            true, ImageAssets.furniture, AppStrings.furniture, '827 items'),
        CategoriesObject(
            true, ImageAssets.lamps, AppStrings.lamps, '827 items'),
        CategoriesObject(
            true, ImageAssets.wooden, AppStrings.wooden, '827 items'),
      ];
}
